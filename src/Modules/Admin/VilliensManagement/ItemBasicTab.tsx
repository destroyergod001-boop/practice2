...
interface VillienBasicTabProps {
  data: Partial<VillienModel>;
  onChange: (data: Partial<VillienModel>) => void;
  errors?: Record<string, string>;
}

export const VillienBasicTab: React.FC<VillienBasicTabProps> = ({ data, onChange, errors = {} }) => {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Enter villien name"
            required
          />
          {errors.name && (
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
          placeholder="Enter villien description"
        />
      </div>
