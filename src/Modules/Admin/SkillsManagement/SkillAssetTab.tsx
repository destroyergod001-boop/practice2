...
interface SkillAssetTabProps {
  data: Partial<SkillModel>;
  onChange: (data: Partial<SkillModel>) => void;
}

export const SkillAssetTab: React.FC<SkillAssetTabProps> = ({ data, onChange }) => {
    ...
    <div className="space-y-6">
      <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
        ...
        <div className="space-y-4">
          <AssetInput
            ...
            description="Path to the skill icon or animation asset"
            acceptedTypes={['image/*']}
            placeholder="e.g., /assets/skills/fireball.png"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Monster that uses this skill (None if not monster-specific)
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Sequence number for monster skills
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Item required to use this skill (None if no requirement)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
          <li>• Use PNG format for skill icons (recommended size: 64x64px)</li>
          <li>• Store assets in the /uploads/skills/ directory</li>
