...
interface ShopAssetTabProps {
  data: Partial<ShopModel>;
  onChange: (data: Partial<ShopModel>) => void;
}

export const ShopAssetTab: React.FC<ShopAssetTabProps> = ({ data, onChange }) => {
  const handleChange = (field: keyof ShopModel, value: any) => {
    ...
    <div className="space-y-6">
      <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
        ...
        <div className="space-y-4">
          <AssetInput
            ...
            description="Path to the shop icon or animation asset"
            acceptedTypes={['image/*']}
            placeholder="e.g., /assets/shops/fireball.png"
          />
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
          <li>• Use PNG format for shop icons (recommended size: 64x64px)</li>
          <li>• Store assets in the /uploads/shops/ directory</li>
