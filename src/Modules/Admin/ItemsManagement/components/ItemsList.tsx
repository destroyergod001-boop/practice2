...
import { useItemsListController, SortField, SortDirection } from '../controllers/ItemsListController';
...
export const ItemsList: React.FC<ItemsListProps> = ({ onEdit, onDelete }) => {
  const { state, controller, filteredItems, paginatedItems, totalPages } = useItemsListController();
              ...
              <tr>
                ...
                <th className="px-6 py-3 text-left">
                  <button
                    ...
                    className="flex items-center gap-1 text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider hover:text-gray-700 dark:hover:text-gray-100"
                  >
                    item_type {getSortIcon('item_type')}
                  </button>
                </th>
                <th className="px-6 py-3 text-left">
                  <button
              ...
              {paginatedItems.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                    {state.searchQuery ? 'No items found matching your search.' : 'No items found. Create your first item to get started.'}
                  </td>
                </tr>
              ) : (
